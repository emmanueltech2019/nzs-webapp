...
const LeftSidenav = () => {
  ...
  return (
    <div className='hidden bg-[#006838] text-white lg:flex justify-between items-center flex-col sticky top-0 h-screen overflow-y-auto max-h-[1200px] min-w-[23vw] max-w-[241px] py-[70px] ps-[35px]'>
