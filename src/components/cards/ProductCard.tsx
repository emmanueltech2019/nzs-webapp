    ...
    return (
        <div className="bg-[#F8F9FE] rounded-2xl w-full  h-fit">
          <div className="flex-grow flex items-center justify-center">
            <Image src={image || "https://res.cloudinary.com/wise-solution-inc/image/upload/v1756030371/product-placeholder_xsuq91.png"} alt={title} width="100" height={'100'} className="rounded-t-2xl h-[120px] md:h-[160px] w-full object-cover"/>
          </div>
