    ...
    <div className="bg-[#F8F9FE] rounded-2xl w-[250px] md:w-[360px] h-[267px] md:h-[300px]">
      ...
      <div className="p-3">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h3 className="font-extrabold font-sans text-sm text-[#1F2024]">{title}</h3>
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-500 mt-2">
          <span className="font-normal text-xs text-[#71727A] flex items-center gap-1"><Icon icon="bxs:star" className='text-[#006838]'></Icon> {rating}</span>
        </div>
        <button
          className={`mt-3 text-center cursor-pointer w-full text-xs font-semibold py-3 px-4 rounded-xl ${isOpen ? "text-[#006838] border border-[#006838]" : "text-gray-400 border border-gray-300"
            }`}
        >
          {isOpen ? "Open" : "Closed"}
        </button>
