      ...
      <section>
        <div>
          ...
          <div className="packages grid md:grid-cols-2 gap-3 pt-12 pb-6">
            {PackageObj(pack).map((item, index) => (
              <div key={'package'+index}>
                ...
                />
                <label htmlFor={`package_${index}`} className="cursor-pointer">
          ...
          <div className="what-you-get bg-[#F8F9FE] p-6 rounded-2xl mb-[24px]">
            ...
            <div className="grid md:grid-cols-3 items-start gap-2 mt-[16px]">
              <div className="flex items-center gap-3">
                <Icon
                  icon="eva:star-fill"
                  className="text-[#006838] text-[11px]"
                ></Icon>
                <p className="text-[#71727A] font-[400] text-xs">
                  50,000 all categories listing
                </p>
              </div>
