        ...
        <div>
          ...
          <div className="choose-role mt-[41px] flex flex-col gap-2">
            <div className="buy p-4 flex justify-between rounded-[12px] bg-[#EAF2FF] cursor-pointer">
              ...
              <input title="buy" type="checkbox" name="buy" id="buy" className="hidden" />
              <label htmlFor="buy">
                <div className="checkbox h-6 w-6 border-[#C5C6CC] border-[1.5px] rounded-md flex items-center justify-center">
                  <Icon
            ...
            <div className="sell p-4 flex justify-between rounded-[12px] bg-[#ffffff] border-[#C5C6CC] border-[0.5px] cursor-pointer">
              ...
              <input title="sell" type="checkbox" name="sell" id="sell" className="hidden" />
              <label htmlFor="sell">
                <div className="checkbox h-6 w-6 border-[#C5C6CC] border-[1.5px] rounded-md flex items-center justify-center">
                  <Icon
                    icon="iconamoon:check-duotone"
