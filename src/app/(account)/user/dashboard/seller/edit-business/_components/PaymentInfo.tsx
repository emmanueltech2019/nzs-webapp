        ...
        <div className='py-3'>
            ...
            <div className="border-[0.5px] border-[#D4D6DD] rounded-2xl p-4 mt-3">
                ...
                <div className='pb-3 flex flex-col gap-3'>
                    <label htmlFor="AccountType" className={`text-sm font-bold text-[#1F2024] ${openSansFont}`}>Account Name</label>
                    <input type="text" id='AccountName' onChange={e => setAccountName(e)} value={accountName} required className='w-full px-4 py-3 rounded-xl outline-none bg-inherit border-[0.67px] border-[#C5C6CC] placeholder:text-[#8F9098]' placeholder='Account Name' disabled />
                </div>
                <div className='pb-3 flex flex-col gap-3'>
