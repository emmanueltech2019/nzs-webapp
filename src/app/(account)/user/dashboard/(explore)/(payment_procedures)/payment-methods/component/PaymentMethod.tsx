...
const PaymentComponent = () => {
  ...
  return (
    <>
    <div className="flex justify-around mb-8 mx-auto ml-20 px-20 ">
        ...
        <div className="flex flex-col items-center text-gray-400 mr-auto">
          <div className="w-8 h-8 rounded-full bg-[#006838] text-white flex items-center justify-center">
            3
          </div>
    ...
    <div className="mx-auto mx-20 py-8 px-5 border rounded-lg ">
      ...
      <div className="mb-6">
        ...
        >
          <div className="flex justify-between items-center">
            <p>Mastercard</p>
            <p>{selectedShipping === "Standard"?<div className="w-8 h-8 rounded-full text-[#006838] pt-5 flex items-center justify-center">
            <CheckOutlinedIcon />
          </div>:''}</p>
          </div>
          <p className="text-gray-500 text-sm">xxxx xxxx xxxx 1234</p>
        </div>
        <div
        ...
        >
          ...
          <p className="text-gray-500 text-sm">xxxx xxxx xxxx 9876</p>
        </div>
