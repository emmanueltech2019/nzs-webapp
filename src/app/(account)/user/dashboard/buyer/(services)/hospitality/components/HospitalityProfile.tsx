...
const HospitalityProfile:FC = () => {
  return (
    <div className='p-3'>
        <div className="flex justify-between items-center">
            <h1 className={`text-[#1F2024] font-black text-lg pb-6 ${interFont}`}>Paradise Resorts</h1>
      ...
      <p className="md:max-w-[427px] text-[#71727A] font-normal pb-10">Sunrise Haven Resort is a luxurious gateway nestled in the heart of Nigeria, offering guests an escape from teh hustle and bustle of everyday life. Surrounded by lush landscapes and serene views, the resort boasts world-class amenities, including spacious accommodations, a spa, gourmet dining, and outdoor recreational activitiies.
      </p>
