            ...
            {topRated.map((item) => (
              <div className="flex items-center justify-between p-4 bg-[#F8F9FE] rounded-2xl">
                ...
                <div className="font-sans">
                  <h3 className="font-extrabold text-sm text-[#1F2024]">
                    {item.company}
                  </h3>
                  <p className="font-normal text-xs text-[#71727A]">
                    {item.location}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <p className="font-normal text-xs text-[#71727A] flex items-center gap-1">
                    <Icon icon="bxs:star" className="text-[#006838]"></Icon>
                    {item.rating}
                  </p>
                  <div className="cursor-pointer">
                    <Icon
                      icon="fluent:ios-arrow-right-24-filled"
                      className="text-[#71727A]"
                    ></Icon>
                  </div>
                </div>
              </div>
