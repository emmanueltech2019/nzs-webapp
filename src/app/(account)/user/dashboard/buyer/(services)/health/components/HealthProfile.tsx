...
const HealthProfile:FC = () => {
  return (
    <div className='p-3'>
      ...
      <p className="md:max-w-[427px] text-[#71727A] font-normal pb-10">We're a leading medical practice in Nigeria, dedicated to providing high-quality, patient-centered care across a range of specialties. Established with vision of delivering world-class healthcare, we have grown into one of the most trusted names in the medical field.
      </p>
