...
const HospitalityProfile:FC = () => {
  return (
    <div className='p-3'>
      ...
      <p className="md:max-w-[427px] text-[#71727A] font-normal pb-10">As a faith-bassed school, Great Faith Integrates spiritual development with regorous academic programs, fostering a well-rounded education for students. The school offers a conducive learning environment. modern facilities, and a dedicated team of experienced educators.
      </p>
      <div className="flex justify-between pb-4">
        <h2 className="font-extrabold ">Similar</h2>
