...
import pricingImg from '@/assets/images/pricing-img.svg'
...
const Pricing = () => {
    return (
        <section className={`${bgImg} relative overflow-x-hidden`}>
            ...
            <div className="pricing-section pt-[83.57px] xl:pt-[96.43px] flex flex-col lg:flex-row gap-[34px] lg:items-end">
                ...
                <div className="hero-image flex-[1.5]">
                    <div className="pricing-img w-full">
                        <Image src={pricingImg} alt="pricing-img" className={`w-full object-cover`} />
                    </div>
                </div>
            </div>
