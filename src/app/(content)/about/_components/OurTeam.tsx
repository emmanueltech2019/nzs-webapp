            ...
            <div className="our-team-section flex items-center flex-col lg:flex-row">
                <div className="col flex-1">
                    <div className="our-team-image">
                        <Image src={"https://res.cloudinary.com/wise-solution-inc/image/upload/v1772541688/Group_1000002332_1_ggm8sv.svg"} alt="our-team-image" className="object-cover w-full" width={100} height={100} />
                    </div>
                </div>
